...
In this post we'll present iso-deriving and show some examples of
iso-deriving in action. We've packaged up all the types and classes
used here in the
...
us know what use cases you find for iso-deriving!
