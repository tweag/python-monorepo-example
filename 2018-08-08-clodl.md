...
These tools require especifying the dependencies, the source
...
However, there are tools that follow this approach as well.
One of these is a commercial tool called [ermine][ermine], which produces a
