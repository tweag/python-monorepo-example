...
Once it finds such an instance (which should be unique, unless one is using [overlapping instances](https://ghc.gitlab.haskell.org/ghc/doc/users_guide/exts/instances.html#instance-overlap)), GHC commits to it, picking up the context as a Wanted constraint (we will cover Wanted and Given constraints in depth in [Part II: § Constraint solving](https://www.tweag.io/posts/2021-09-10-tcplugins-2.html#constraint-solving)).
...
in [Part II: § Constraint solving](https://www.tweag.io/posts/2021-09-10-tcplugins-2.html#constraint-solving),
is as follows:
