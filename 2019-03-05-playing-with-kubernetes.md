...
**Note**: What I am presenting here is for motivational purposes only and you should certainly put more thought into your setup if you want to
...
The image will include everything that is required to execute `hello-app` - i.e the closure of the `helloApp` derivation.
...
With deployments configured in JSON or YAML we have files as smallest unit to work with. There is little that can be done in terms of
