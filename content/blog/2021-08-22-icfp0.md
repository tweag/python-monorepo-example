...
**Noon** &mdash; Higher-order Programming with Effects and Handlers by Jonathan Immanuel Brachthäuser
...
**Noon** &mdash; Computational and Contextual Program Differences by Francesco Gavazzo
...
**Noon** &mdash; Functional Machine Calculus by Willem Heijltjes
...
**Noon** &mdash; Integrating Agda with SMT Solvers by Wen Kokke
...
**Noon** &mdash; Testing Haskell with Mocks by Chris Smith
...
**Noon** &mdash; Introduction to Mechanized Metatheory by Brigitte Pientka

- Enjoyed this presentation about what is required when proving things about type systems.

**Noon** &mdash; Emotional Machines by Aaron Turon
