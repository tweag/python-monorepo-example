...
It could either be discrete, in which case we would keep talking about a transition matrix \\(T\\), or be continuous, in which case \\(T\\) would be a transition *kernel*.
