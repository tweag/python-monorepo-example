...
[Elasticsearch][elastic], which helps you store, search and analyze your data,
and [Kibana][kibana], an [Elasticsearch][elastic] plugin, that helps you
...
micro-benchmarking code and [Elasticsearch][elastic], to which we offload all
...
* Use [Hyperion][hyperion]'s `--raw` mode with [Elasticsearch][elastic]'s
  ...
  get get great insight into your benchmark data,
