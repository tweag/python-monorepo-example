...
commit (if you want to, to update the commit in kibana's results), upload with the same command as above
...
Visualize -> Create a new visualization -> Line -> hyperion*

![fib.png](Fibonacci stuff)

Note that you can also run it several times and select "Average" or something
else instead of "Max".
