...
Funflow is a workflow system in Haskell based on
[arrows](https://www.haskell.org/arrows/). Arrows can be seen as a generalisation
...
One of the main advantages of arrows is that they are strictly less powerful
than monads. This lack of power means we can reason more about them. By using
arrows we can, for example, write in idiomatic Haskell code but acquire a DAG
representation of our computation, which we can inspect, visualise, optimise
etc.

Funflow has a number of features unique (to the best of our
