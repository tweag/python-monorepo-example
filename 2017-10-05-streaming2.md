...
as they allow programs to be conveniently composed. We will use the
packages
[pipes](http://hackage.haskell.org/package/pipes),
[conduit](http://hackage.haskell.org/package/conduit),
[streaming](http://hackage.haskell.org/package/streaming),
and
[io-stream](http://hackage.haskell.org/package/io-streams) to
illustrate the explained concepts,
showing that they are generally applicable to streaming libraries.
...
`streaming` and `io-stream` manipulate streams directly.
...
which might be produced by performing efectful computations in the
