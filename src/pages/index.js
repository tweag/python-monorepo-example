                  ...
                  <div className="container fullp animation-wrap">
                    <div className="visual-holder">
                      ...
                      <div className="visual-caption">
                        ...
                        <p>
                          We enable deep tech startups to achieve their vision,
                      ...
                      <div className="text-area">
                        <ul className="text-list">
                          <li>
                            ...
                            <p>
                              Quickly grow your team with vetted, senior
                              engineers. Tweag provides the expertise needed to
                              execute high-risk, high-reward projects.
                            </p>
                          </li>
                          <li>
                            <h3>Increase developer productivity</h3>
                            <p>
                              Gain a developer efficiency boost through software
                              best practices and processes that accelerate your
                              time to market.
                            </p>
                          </li>
                          <li>
                            ...
                            <p>
                              Realize your breakthrough vision. Together,
                              we&apos;ll iterate quickly and transform your
                    ...
                    <div className="joinus-holder animation-wrap">
                      <div className="text-wrap">
                        <strong className="title">
                          At Tweag, we drive purposeful innovation through
                          lasting software. We apply mathematics, computer
                          science and open source methodologies to advance
